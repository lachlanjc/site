...
const theme = {
  ...
  colors: {
    ...
    elevated: palette.snow,
    elevatedText: palette.green,
    primary: palette.yellow,
    secondary: palette.indigo,
    muted: palette.greenMutedHi,
    accent: palette.fuschia,
    modes: {
      dark: {
        text: palette.light,
        background: '#0c0b0a',
        ...
        muted: palette.greenMutedLo
      }
    }
  },
  fonts: {
    display:
      '"Hubot Sans", system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',
    body: '"Mona Sans", system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',
    heading: 'inherit',
  ...
  shadows: {
    border: '0 0 0 1px rgba(0,0,0,.08)',
    inset: 'inset 0 0 0 1px rgba(0,0,0,.08), 0 2px 2px rgba(0,0,0,.04)',
    text: '0 1px 2px rgba(0, 0, 0, 0.25), 0 2px 4px rgba(0, 0, 0, 0.125)',
    small: '0 1px 2px rgba(0, 0, 0, 0.0625), 0 2px 4px rgba(0, 0, 0, 0.0625)',
    card: '0 0 0 1px rgba(0,0,0,.08), 0 1px 1px rgba(0,0,0,.02), 0 4px 8px -4px rgba(0,0,0,.04), 0 16px 24px -8px rgba(0,0,0,.06)',
    elevated: '0 0 0 1px rgba(0,0,0,.08), 0 1px 1px rgba(0,0,0,.02), 0 8px 16px -4px rgba(0,0,0,.04), 0 24px 32px -8px rgba(0,0,0,.06)'
  },
  text: {
    heading: {
      fontWeight: 'bold',
